...
// set conditions
    // if an empty value is submitted, validatation of user input
    // if a negative value is submitted
    // if a value greater (>) than .length in the array

// ... just display a random paragraph if the conditions are not met.
